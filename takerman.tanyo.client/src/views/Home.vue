...
<a href="#" class="js-colorlib-nav-toggle colorlib-nav-toggle" data-toggle="collapse" data-target="#navbar" aria-expanded="false" aria-controls="navbar"><i></i></a>
			<aside id="colorlib-aside" role="complementary" class="border js-fullheight">
				<div class="text-center">
					...
					<h1 id="colorlib-logo"><a href="index.html">Tanyo Ivanov</a></h1>
								...
								<div class="row row-bottom-padded-sm animate-box" data-animate-effect="fadeInLeft">
									<div class="col-md-12">
										<div class="about-desc">
											...
											<p><strong>Hi I'm Tanyo Ivanov</strong> I used C oriented languages since 2008 and started my first work at 2010. It was a complicated path as the companies are just establishin in my hometown Plovdiv, but also there was a transition to open sourced framework. Since then I worked on small and extremely large projects and companies. In foreign countries and from my hometown too. With software, but also with hardware. After my 8 hours day I definaly stayed for at least 3-4 hours most of the days to improve and educate my self, or to work on something that brings me joy. The things that brings me joy for now are: software design, automated testing, 3D printing, severs management and infrastructure improvements.</p>
											<p>In my blog you can find some of the things that I make after work in my free time. In my portfoli you can findbrief explanation on projects I worked on as well some own creations free to use or download.</p>
										</div>
									</div>
								</div>
								<div class="row">
					...
					<div class="colorlib-narrow-content">
						...
						<div class="row">
							<div class="col-md-3 text-center animate-box">
								<span class="colorlib-counter js-counter" data-from="0" data-to="2010" data-speed="5000" data-refresh-interval="50"></span>
								<span class="colorlib-counter-label">Working since</span>
							</div>
							<div class="col-md-3 text-center animate-box">
