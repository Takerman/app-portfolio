...
$optimizer_i18n_strings = array(
	...
	__( 'Manual Dynamic Cache Purge', 'sg-cachepress' ),
	__( "Purge the Dynamic Cache of your website manually. You can use this option when you're modifying new content and don't have automatic purge enabled to make sure that old cached is purged right away. ", 'sg-cachepress' ),
