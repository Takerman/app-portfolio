<tr>
                    <td class="body-text"
                        style="color: #363636; font-weight: 700; font-family: 'Roboto', Arial, Helvetica, sans-serif; font-size: 20px; line-height: 30px; padding: 0 0 20px 0"><?php esc_html_e( 'Increase Security with Superiour Hosting', 'sg-security' ); ?>
                    </td>
                </tr>
                <tr>
                        ...
                        <table class="infobox" border="0" cellpadding="0" cellspacing="0" width="100%"
                            ...
                            <tr>
                                <td class="body-text"
                                    ...
                                    <?php esc_html_e( 'Limit bot visits and bruteforce attacks with superior hosting', 'sg-security' ); ?>
                                </td>
                            </tr>
                            <tr>
                                <td class="body-text"
                                    ...
                                    <?php esc_html_e( 'Get a special deal on WordPress hosting made with security in mind:', 'sg-security' ); ?>
                                </td>
                            </tr>
                            <tr>
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                    <tr>
                                                        <td class="body-text"
                                                            ...
                                                            <?php esc_html_e( 'Powerful AI anti-bot system', 'sg-security' ); ?>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="body-text"
                                                            style="color: #444444; font-weight: 400; font-family: 'Open Sans', Arial, Helvetica, sans-serif; font-size: 16px; line-height: 26px;">
                                                            <span style="color: #cdaa72; display: inline-block; padding: 0 5px 0 0;">&#8226;</span>
                                                            <?php esc_html_e( 'Smart and constantly updated WAF', 'sg-security' ); ?>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="body-text"
                                                            style="color: #444444; font-weight: 400; font-family: 'Open Sans', Arial, Helvetica, sans-serif; font-size: 16px; line-height: 26px;">
                                                            <span style="color: #cdaa72; display: inline-block; padding: 0 5px 0 0;">&#8226;</span>
                                                            <?php esc_html_e( 'Geo-redundant backups', 'sg-security' ); ?>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="body-text"
                                                            style="color: #444444; font-weight: 400; font-family: 'Open Sans', Arial, Helvetica, sans-serif; font-size: 16px; line-height: 26px;">
                                                            <span style="color: #cdaa72; display: inline-block; padding: 0 5px 0 0;">&#8226;</span>
                                                            <?php esc_html_e( 'Free SSL for all sites', 'sg-security' ); ?>
                                                    ...
                                                    <tr>
                                                        <td class="body-text"
                                                            ...
                                                            <a href="https://www.siteground.com/technology#security-solution" target="_blank" rel="noreferrer" style="color: #22b8d1; text-decoration: none;"><strong><?php esc_html_e( 'Learn More', 'sg-security' ); ?></strong></a>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="body-text"
                                            ...
                                            <td width="180" valign="top" class="dblock">
                                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                    <tr>
                                                       ...
                                                       <img src="https://www.siteground.com/static/en/img/emails/plugins/sg_security/brutforce_attack_banner.png" width="177" alt="Brutforce Icon">                                                        </td>
                                                    </tr>
