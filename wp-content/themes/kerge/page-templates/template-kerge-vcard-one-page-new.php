<?php
/*
Template Name: Kerge vCard One Page NEW
*/
get_header(); ?>
...
<div id="main" class="site-main">
    ...
    <div class="pt-wrapper one-page-new">
        <!-- Subpages -->
                        ...
                        if ( $loop_custom_page->have_posts() ) :
                            while ( $loop_custom_page->have_posts() ) : $loop_custom_page->the_post();
                                ...
                                ?>
                                    ...
                                    <section id="<?php echo esc_attr($slug); ?>" class="pt-page pt-page-<?php echo esc_attr($slug); ?> animated-section start-page <?php echo esc_attr($start_page_style); ?>">
                                ...
                                <?php
                                    ...
                                    ?>
                                    <section id="<?php echo esc_attr($slug); ?>" class="pt-page pt-page-<?php echo esc_attr($slug); ?> animated-section">
                                        <div class="section-inner custom-page-content">
