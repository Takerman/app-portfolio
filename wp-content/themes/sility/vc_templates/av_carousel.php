...
/****/
vc_map( array(
   "name" => __("Sility Content Slider", "Sility"),
   ...
   "params" => array(
	   ...
	   array(
	    ...
	    array(
         "type" => "textfield",
         "class" => "",
         "heading" => __("Autoplay speed(milliseconds)", "Sility"),
         "param_name" => "speed",
         "value" => '3000'
      ),
