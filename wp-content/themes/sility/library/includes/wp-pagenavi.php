...
function wp_pagenavi($before = '', $after = '') {
	...
	$pagenavi_options = array(
		...
		'next_text' => __('<span class=" fa fa-chevron-right"></span>','Sility'),
		'prev_text' => __('<span class="fa fa-chevron-left"></span>','Sility'),
...
function pagenavi_init() {
	...
	$pagenavi_options = array(
		...
		'current_text' => '%PAGE_NUMBER%',
		'page_text' => '%PAGE_NUMBER%',
		'first_text' => __('','Sility'),
		'last_text' => __('','Sility'),
		'next_text' => __('<span class="icon-chevron-right"></span>','Sility'),
		'prev_text' => __('<span class="icon-chevron-left"></span>','Sility'),
		'dotright_text' => __('...','Sility'),
		'dotleft_text' => __('...','Sility'),
		'style' => 1,
		'num_pages' => 5,
		'always_show' => 0,
		'num_larger_page_numbers' => 3,
