        ...
        <div class="owl-carousel owl-theme testimonial-slider">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="testi-img mb-4 mb-lg-0">
                            <img src="/img/testimonials/anders.jpg" alt="">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="testi-right">
                            ...
                            <p>
                                ...
                                <a href="/files/recomendations/AndersPersson.pdf" target="_blank"><strong>Recomendation</strong></a>
                            </p>
            ...
            <div class="testimonial-item">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="testi-img mb-4 mb-lg-0">
                            <img src="/img/testimonials/ivo.jpg" alt="">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="testi-right">
                            ...
                            <p>
                                ...
                                <a href="/files/recomendations/IvayloIvanov.pdf" target="_blank"><strong>Recomendation</strong></a>
                            </p>
            ...
            <div class="testimonial-item">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="testi-img mb-4 mb-lg-0">
                            <img src="/img/testimonials/ivan.jpg" alt="">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="testi-right">
                            ...
                            <p>
                                ...
                                <a href="/files/recomendations/IvanLekushev.pdf" target="_blank"><strong>Recomendation</strong></a>
                            </p>
                            <ul class="star_rating mt-3">
                                <li><span><i class="fas fa-star"></i></span></li>
                                <li><span><i class="fas fa-star"></i></span></li>
